 ...
 * vertical) — se porta aquí, al módulo compartido core.financiero, para que
 * Comercio y Mediclinic (y cualquier otra vertical) se rijan por el mismo
 * mecanismo en vez de mantener una fuente de datos distinta por vertical.
 */
@Service
