...
public class AuroraWhatsappIaService {
    ...
    public RespuestaIaDTO procesarMensaje(Long tenantId, String telefonoCliente, String mensajeCliente) {
        ...
        // 2. Deteccion de Intencion: PAGO MOVIL / DATOS BANCARIOS
        if (msgLower.contains("pago movil") || msgLower.contains("pago móvil") || msgLower.contains("pagomovil") 
            ...
            String telf = licencia.getPagoMovilTelefono() != null ? licencia.getPagoMovilTelefono() : (licencia.getTelefonoContacto() != null ? licencia.getTelefonoContacto() : "04141112233");
            String doc = licencia.getPagoMovilDocumento() != null ? licencia.getPagoMovilDocumento() : (licencia.getRif() != null ? licencia.getRif() : "J-12345678-0");
            String titular = licencia.getPagoMovilTitular() != null ? licencia.getPagoMovilTitular() : nombreTienda;
