import { useCallback, useEffect, useMemo, useRef, useState, type ReactNode, type PointerEvent as ReactPointerEvent, type KeyboardEvent as ReactKeyboardEvent } from "react";
import gsap from "gsap";
import "./DepthCarousel.css";

// react-bits.dev — DepthCarousel (JS+CSS oficial, portado a TS). Tarjetas
// apiladas en profundidad (translateZ/rotateY) que se deslizan con drag,
// rueda del mouse, flechas de teclado o autoplay. Extendido con un campo
// `content` opcional para poder mostrar tarjetas de contenido (icono +
// texto) en vez de solo imágenes, ya que el snippet original de
// react-bits.dev solo contemplaba slides de imagen.
    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          <div
            key={i}
            className={`depth-carousel__card${item.content ? " depth-carousel__card--content" : ""}`}
