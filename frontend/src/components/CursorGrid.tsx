...
// react-bits.dev — CursorGrid (JS+CSS oficial, portado a TS). Rejilla de
// celdas que se iluminan al pasar el cursor cerca (o al hacer click, con
// un pulso expansivo), dibujada en un <canvas> con requestAnimationFrame.
