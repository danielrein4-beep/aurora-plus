...
// react-bits.dev — SpecularButton (JS+CSS oficial, portado a TS para el resto
// del proyecto). Dibuja un brillo WebGL que recorre el borde redondeado del
// botón, siguiendo el cursor en toda la página (no solo dentro del botón).
