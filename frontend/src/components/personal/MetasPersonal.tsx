              ...
              <div className="space-y-2">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <h4 className="font-bold tracking-tight text-slate-900 text-sm mt-1.5">{meta.titulo}</h4>
                  </div>
        ...
        >
          <div className="bg-slate-50 border border-slate-200 w-full max-w-md max-h-[90vh] overflow-y-auto rounded-2xl p-4 sm:p-6 space-y-4 shadow-2xl">
            <div className="flex items-center justify-between">
              <h3 id="modal-crear-meta-titulo" className="text-base font-bold tracking-tight text-slate-900">
