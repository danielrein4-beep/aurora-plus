      ...
      >
        <div className="flex-1 space-y-1">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-medium text-slate-900">{c.concepto}</span>
        ...
        <div className="text-right sm:pl-4 sm:border-l sm:border-[#1e293b] self-end sm:self-center">
          <span className="text-[10px] text-slate-500 block sm:hidden">Resultado:</span>
          <span
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 p-3 bg-slate-50 rounded-lg border border-slate-200">
        <div>
          <h4 className="font-semibold text-slate-900 text-xs">{recibo.empleadoNombre}</h4>
        ...
        <div className="flex items-center gap-4 text-xs">
          <div className="text-right">
            <span className="text-slate-500 block text-[10px]">Días computados</span>
            <span className="font-mono font-medium text-slate-900">{recibo.diasTrabajados} días</span>
          </div>
          <div className="text-right">
            <span className="text-slate-500 block text-[10px]">Horas extras</span>
            <span className="font-mono font-medium text-slate-900">{recibo.horasExtrasTotal} hrs</span>
          </div>
          <div className="text-right pl-3 border-l border-slate-200">
            <span className="text-slate-500 block text-[10px]">Neto a liquidar</span>
