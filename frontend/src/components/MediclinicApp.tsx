...
import {
  ...
  contadorInboxLaboratorio, listarOrdenesLaboratorioPaciente,
...
type Pagina = "general" | "pacientes" | "historias" | "procedimientos" | "sala-espera" | "agenda" | "laboratorio" | "financiero" | "configuracion";
...
export default function MediclinicApp({ onSalir }: { onSalir: () => void }) {
  ...
  const cargarContadorLab = () => {
    contadorInboxLaboratorio(tenantId)
      .then((res) => setInboxLabPendientes(res.pendientes))
      .catch(() => {});
  };
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0 ml-1">
                  ...
                  {esProtegida && (
                    <span title="Requiere clave del Doctor" className="text-slate-400 dark:text-white/40">
                      <IconLock size={12} />
                    </span>
                  )}
                </div>
