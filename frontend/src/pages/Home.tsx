...
const VERTICALS = [
  ...
  },
  {
    ...
    tagline: "Administracion de ganado, ordeno, vacunacion, mapas y pesaje",
    desc: "Plataforma integral para fincas ganaderas y lecheras. Administracion de rebanos con trazabilidad individual, control diario de ordeno y tanque de leche, calendario de vacunacion y sanidad animal, mapas satelitales con calculo geodesico de hectareas (WGS84) y pesaje en corral con basculas Bluetooth en modo offline.",
    Icon: IconFarm,
    color: "from-emerald-500/20 to-teal-500/10",
    badge: "Gestion ganadera integral",
    stats: [
      { label: "Rebanos y Hato", value: "340 animales", sub: "Trazabilidad por arete y GDP", color: "text-teal-600 dark:text-teal-400" },
      { label: "Produccion de ordeno", value: "1,250 Lts/dia", sub: "Control manana/tarde y tanque", color: "text-slate-800 dark:text-white/80" },
      { label: "Plan sanitario", value: "Al dia (Aftosa/Rabia)", sub: "Alertas de vacunacion y lote", color: "text-slate-800 dark:text-white/80" },
    ],
    features: [
      "Administracion de rebanos: ficha individual por arete, categoria, genealogia y curva de ganancia de peso (GDP)",
      "Control de ordeno y tanque: registro diario por vaca (manana y tarde), monitoreo de mastitis y despachos de leche",
      "Seguimiento de vacunacion: calendario sanitario oficial (aftosa, rabia, brucelosis), desparasitacion y alertas en lote",
      "Cartografia satelital y potreros: imagenes Esri, calculo geodesico de hectareas (WGS84) y aforo forrajero",
      "Basculas Bluetooth y modo offline: captura de peso en corral sin internet y sincronizacion automatica",
    ],
  },
];
