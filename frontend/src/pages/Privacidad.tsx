export default function Privacidad() {
  return (
    <main className="w-full bg-white text-[#1D1D1F] antialiased pt-28 pb-24 px-6 sm:px-8">
      <div className="max-w-3xl mx-auto">
        <p className="text-xs font-semibold tracking-widest text-[#177E89] uppercase mb-3">Legal</p>
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#1D1D1F] mb-4">
          Política de Privacidad
        </h1>
        <p className="text-[#86868B] text-sm mb-12">Última actualización: septiembre de 2026.</p>

        <div className="space-y-10 text-[#6E6E73] text-sm leading-relaxed">
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">1. Qué datos recolectamos</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">2. Cómo protegemos tus datos</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">3. Con quién compartimos tus datos</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">4. Cuánto tiempo guardamos tus datos</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">5. Tus derechos</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">6. Cambios a esta política</h2>
          ...
          <section>
            <h2 className="font-bold tracking-tight text-xl text-[#1D1D1F] mb-3">7. Contacto</h2>
            <p>Para cualquier pregunta sobre tus datos o esta política, escríbenos a <span className="text-[#177E89] font-medium">auroraplussoftware@gmail.com</span>.</p>
          </section>
        </div>
      </div>
    </main>
